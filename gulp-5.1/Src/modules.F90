...
!
  module fitting
    ...
    character(len=15),                    save :: fitlabel(28,61,9)
    character(len=10),                    save :: fitlabelunits(28,61,9)
    integer(i4),                          save :: nfitlabel(61,9)
...
!
  module potentialnames
    use datatypes
    integer(i4),                          save :: max2pottype = 61
    integer(i4),                          save :: max3pottype = 24
    integer(i4),                          save :: max4pottype = 17
    character(len=13),                    save :: name2pot(61)             ! Names of twobody potentials
