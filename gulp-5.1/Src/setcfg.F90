...
!
      ncorepcfg(ii) = ncore
      do i = 1,3
        rvpcfg(1:3,i,ii) = rvcfg(1:3,i,ii)
      enddo
!
      do i = 1,3
        rvt(1,i) = rv(1,i)
...
!
    lshrink = ((nks(1,ii)*nks(2,ii)*nks(3,ii)).gt.0)
    if (ioproc) then
!*******************************
      ...
      if (ndimen(ii).eq.3) then
        if (.not.lterseincell) then
          ...
          if (lstraincell) then
            ...
            write(ioout,'(4x,6f12.6)')(straincfg(j,ii),j=1,6)
          endif
        endif
...
!
      ...
      elseif (ndimen(ii).eq.2) then
        ...
        if (.not.lterseincell) then
          ...
          if (lstraincell) then
            write(ioout,'(/,''  Initial strains :'',/)')
            write(ioout,'(4x,3f12.6)')(straincfg(j,ii),j=1,3)
          endif
        endif
      ...
      elseif (ndimen(ii).eq.1) then
        if (.not.lterseincell) then
          ...
          if (lstraincell) then
            ...
            write(ioout,'(4x,f12.6)') straincfg(1,ii)
          endif
        endif
        if (.not.lterseincell) then
      ...
      if (lshrink) then
        if (ndimen(ii).eq.3) then
          write(ioout,'(/,''  Shrinking factors = '',3(4x,i2))') nks(1,ii),nks(2,ii),nks(3,ii)
        elseif (ndimen(ii).eq.2) then
          write(ioout,'(/,''  Shrinking factors = '',2(4x,i2))') nks(1,ii),nks(2,ii)
        elseif (ndimen(ii).eq.1) then
          write(ioout,'(/,''  Shrinking factor = '',4x,i2)') nks(1,ii) 
        endif
      endif
