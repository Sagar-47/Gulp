  subroutine gruneisen(nk,mcv,msv,ncfoc,eigr,eigi,dervr,dervi,maxd2,rmass,iocptr,fscale,lprint)
!
...
!
    ...
    do i = 1,ncfoc
      ...
      do j = 1,msv
        ...
        dervi(mcv+j,ix) = rmass(i)*dervi(mcv+j,ix)
        dervi(mcv+j,iy) = rmass(i)*dervi(mcv+j,iy)
        dervi(mcv+j,iz) = rmass(i)*dervi(mcv+j,iz)
      enddo
    enddo
!
