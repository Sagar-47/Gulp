...
!
!  Julian Gale, Curtin University, March 2016
!
  ...
  character(len=80), save :: plumedinput       ! Name of plumed input file
  character(len=80), save :: plumedlog         ! Name of plumed log file
