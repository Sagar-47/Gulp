...
code Alamode has been added that automates the calculation of the thermal 
...
\noindent \textbf{(a) Control of calculation type}\\
 \texttt{alamode, angle, bond, cosmo, cosmic, cost, defect, distance, eem, eembond, efg, eharmonic, fit, free\_energy,
...
\noindent \textbf{(c) Algorithm} \\
 \texttt{allbonds, c6, dipole, fbfgs, fix\_molecule, full, ghostcell, hill, kfull, marvinSE, madelung,
...
{\texttt{-k}}&compile and link to OpenKIM version 2\\
